...
class LMMinePage: LMPageWrapper {
    ...
    override func viewDidLoad() {
        ...
        setupFloatingMenu()
        // Banner must be in the hierarchy before any chrome constraints reference layout.
        setupBannerAd()
    ...
    /**
     ...
     Kept above the scroll view so the ad is not covered by full-bleed content.
     */
    ...
    /**
     ...
     Do **not** constrain to `bannerContainer.top` — that crashes if either view is
