...
struct LMCameraTextConfig: Codable {
    ...
    var tutorialFindSceneDescription: String = "Spot a scene you love but don't know how to frame it? No worries—let AI guide the shot."
    var tutorialTapButtonTitle: String = "Tap the Button"
    var tutorialTapButtonDescription: String = "Tap Inspire Me to scan the scene and generate composition suggestions."
    var tutorialViewAndSelectTitle: String = "View and Select"
    var tutorialViewAndSelectDescription: String = "Browse the suggestions, swipe up to select one, and tap Like to save it to Saved Ideas."
    var tutorialAlignGuidanceTitle: String = "Align the Guidance"
    var tutorialAlignGuidanceDescription: String = "Use AR guidance to match your shot with the selected composition."
    var tutorialSavePhotoTitle: String = "Save the Photo"
    var tutorialSavePhotoDescription: String = "Save the final photo to Saved Ideas or your local album when you're happy with the result."
