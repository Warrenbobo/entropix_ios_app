...
struct LMCameraTextConfig: Codable {
    ...
    // Inspire / Pre-Shoot Plan Button
    var inspireMeButton: String = "Inspire Me"
    var inspirePointsFormat: String = "Inspire Point -%d"
    var preShootPlanButtonCamera: String = "Camera"
    var preShootPlanButtonFindSpot: String = "Find Spot"
    var preShootPlanButtonComposition: String = "Get Template"
    var preShootPlanLongPressHint: String = "Tap to switch mode"
    var preShootPlanModeSheetTitle: String = "Choose mode"
    var preShootPlanHintFindSpot: String = "Tap shutter to find spots"
    var preShootPlanHintGetTemplate: String = "Tap shutter for templates"
    var getTips: String = "Get Tips"
    var instructPhaseCapture: String = "Capture"
    var instructPhaseScorePrepare: String = "Score prepare"
    var instructPhaseGlobal: String = "Global"
    var instructPhaseGeometric: String = "Geometric"
    var instructPhaseHuman: String = "Human"
    var instructPhaseFuse: String = "Fuse"
    var instructPhaseThinking: String = "Thinking"
    var llmRetryableNetworkError: String = "Connection interrupted. Tap to retry."
    var ctaGoToSpot: String = "Go to Spot"
    var ctaGenerateSpotComposition: String = "Get template"
...
struct LMProfileTextConfig: Codable {
    ...
    var savedIdeas: String = "Liked Suggestion"
    var mineTabLikedSuggestion: String = "Liked Suggestion"
    var mineTabSceneHistory: String = "Scene History"
    var noSavedIdeasYet: String = "No liked compositions yet"
    var noSceneHistoryYet: String = "No scene history yet"
...
struct LMSettingsTextConfig: Codable {
    ...
    var modelsSubtitle: String = "Configure Scene Explore, Idea Inspiration, and AR Guidance"
    var modelsSectionGemini: String = "Gemini"
    var modelsSectionQwen: String = "Qwen"
    var modelsSectionSceneExplore: String = "Scene Explore"
    var modelsSectionIdeaInspiration: String = "Idea Inspiration"
    var modelsSectionARGuidance: String = "AR Guidance"
    var modelsProtocolOpenAICompatible: String = "OpenAI-compatible Chat Completions"
    var modelsProtocolGemini: String = "Gemini generateContent"
    var modelsConfigured: String = "Configured"
    var modelsNotConfigured: String = "Not configured"
    var modelsEnableThinking: String = "Enable thinking"
    var modelsEnableThinkingRecommendOff: String = "(recommend OFF)"
    var modelsEnableThinkingHint: String = "Applies to Scene Explore and AR Guidance"
    var modelsThinkingBudget: String = "Thinking budget"
    var modelsTemperature: String = "Temperature"
    var modelsMaxTokens: String = "Max tokens"
    var modelsModelName: String = "Model name"
    var modelsModelRequired: String = "Model name is required"
    var modelsThinkingBudgetInvalid: String = "Thinking budget must be 16–65536"
    var modelsTemperatureInvalid: String = "Temperature must be 0–1.5"
    var modelsMaxTokensInvalid: String = "Max tokens must be 256–16384"
    var modelsRestoreDefaults: String = "Restore defaults"
    var modelsResetToDefaultFormat: String = "%@ model settings reset to default"
    var modelsMissingConfigTitle: String = "Model not configured"
    var modelsMissingConfigMessage: String = "Configure %s in Mine → Setting → Models to continue."
    var modelsGoToConfig: String = "Open Models"
    var modelsSceneExploreHint: String = "Used by Find Spot / Scene Explore VLM"
    var modelsIdeaInspirationHint: String = "Used by Get Template / Inspire Me image generation"
    var modelsARGuidanceHint: String = "Used by Agent coaching chat"
    ...
    var qwenNotConfigured: String = "Configure AR Guidance in Mine → Setting → Models first"
